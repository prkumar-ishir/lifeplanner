...
- A landing page that frames the journey in three sections (Foundations, Reflection, Execution).
...
1. **Explore the journey** – Scan the three-section overview and jump into either the dashboard or planner flow.
...
4. **Check the dashboard** – Surfaces overall progress, the latest weekly plan, and lets you click captured steps to revisit them.
5. **Log weekly plans** – Collects year/month/week, focus, wins, and notes.
